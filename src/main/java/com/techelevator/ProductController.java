...
public class ProductController {
	...
	public String showProductList(HttpServletRequest request) {
		List<Product> products = getProducts(request); //takes us to getProducts method for sort and filter to apply
	...
	private List<Product> getProducts(HttpServletRequest request) {            //this will then call getSortOrder
